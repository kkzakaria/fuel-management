/**
 * Filtres en dropdown pour les sous-traitants (desktop)
...
interface SousTraitantFiltersDropdownProps {
...
export function SousTraitantFiltersDropdown({
  filters,
  onFiltersChange,
  onClearFilters,
  activeFiltersCount,
  triggerLabel = "Filtrer",
}: SousTraitantFiltersDropdownProps) {
  return (
    <Popover>
